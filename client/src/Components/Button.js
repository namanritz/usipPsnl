...
function Button({
  ...
  const classes = className(
    rest.className,
    "flex items-center px-2 py-2 mx-2 my-2 font-bold text-white border-4  duration-500",
    {
      ...
      "text-white cursor-pointer bg-[#006d77] p-2 border-none hover:scale-105 duration-500":
        bgGreen,
      "text-white cursor-pointer bg-[#9381ff] p-2 border-none hover:scale-105 duration-500":
        bgPurple,
    }
  );
